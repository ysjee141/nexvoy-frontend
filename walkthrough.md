...
- Android `preview` local build의 Gradle release bundling 실패를 해결하기 위해 mobile/root entry shim, Metro `@/` alias resolver, `metro-runtime`, `babel-preset-expo@54.0.11` 명시 의존성을 추가했다.

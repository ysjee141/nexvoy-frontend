...
export interface SubscribeWebAuthorityInvalidationInput {
  ...
  onMetric?: (metric: WebAuthorityRealtimeMetric) => void
  onError?: (error: unknown) => void
}

export interface WebAuthorityInvalidationSubscription {
  topic: string
  unsubscribe(): Promise<void>
}

export async function subscribeWebAuthorityInvalidation(
  input: SubscribeWebAuthorityInvalidationInput,
): Promise<WebAuthorityInvalidationSubscription> {

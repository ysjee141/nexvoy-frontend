        ...
        <>
            ...
            <div className={css({
                ...
                <div className={css({ display: 'flex', gap: '8px' })}>
                    <button
                        onClick={handleAllow}
                        className={css({ flex: 1, py: '9px', bg: '#4052D2', color: 'white', borderRadius: '8px', border: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '13px', _hover: { bg: '#4052D2' } })}
                    >
                        알림 허용
                    </button>
                    <button

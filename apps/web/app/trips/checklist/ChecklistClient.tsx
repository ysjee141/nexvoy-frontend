                ...
                >
                    ...
                    >
                        ...
                        <div className={css({ 
                            ...
                            boxShadow: status.is_my_checked ? '0 2px 6px rgba(64, 82, 210, 0.15)' : 'none'
                        })}>
                    ...
                    <div className={css({ p: '24px', display: 'flex', flexDirection: 'column', gap: '20px' })}>
                        <div>
                            ...
                            <input 
                                ...
                                className={css({ w: '100%', p: '12px', border: '1px solid', borderColor: 'brand.hairlineSoft', borderRadius: '12px', fontSize: '16px', outline: 'none', _focus: { borderColor: 'brand.primary', boxShadow: '0 0 0 2px rgba(64, 82, 210, 0.1)' } })}
                            />
                        </div>
        ...
        <div className={css({ bg: 'white', p: { base: '0', sm: '24px' }, borderRadius: { base: 0, sm: '16px' }, boxShadow: { base: 'none', sm: '0 4px 12px rgba(0,0,0,0.02)' }, pb: { base: '80px', sm: '24px' } })}>
            ...
            {totalItems > 0 && (
                <div className={css({ w: '100%', bg: 'bg.surfaceSoft', h: '12px', borderRadius: '16px', mb: '24px', overflow: 'hidden', border: '1px solid', borderColor: 'brand.hairlineSoft' })}>
                    <div
                        className={css({ h: '100%', bg: 'linear-gradient(90deg, #4052D2, #4f46e5, #6366f1)', borderRadius: '16px', transition: 'width 0.8s cubic-bezier(0.1, 0.7, 0.1, 1)' })}

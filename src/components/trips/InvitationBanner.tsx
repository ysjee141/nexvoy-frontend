    ...
    return (
        <div className={css({
            ...
            <div className={css({
                ...
                <div className={css({ display: 'flex', alignItems: 'center', gap: '8px', color: '#1a73e8', fontSize: '14px', fontWeight: '500' })}>
                    <Mail size={18} />
                ...
                <div className={css({ display: 'flex', gap: '8px', w: { base: '100%', sm: 'auto' } })}>
                    {invitations.map((inv) => (
                        <div key={inv.id} className={css({
                            ...
                            <span className={css({ fontSize: '13px', fontWeight: 'bold', color: '#111' })}>
